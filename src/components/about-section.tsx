      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="lg:sticky lg:top-20">
            <div ref={containerRef} className="relative text-left overflow-hidden rounded-lg">
          ...
          <div className="space-y-8">
            ...
            <Card className="glassmorphism p-6 md:p-8 text-left transition-all duration-300 border-primary/30 hover:border-primary/80 hover:shadow-[0_0_20px_hsl(var(--primary)_/_0.3)]">
