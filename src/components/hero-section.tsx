  ...
  return (
    <section id="home" className="h-screen w-full flex items-center justify-center text-center">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-5xl md:text-7xl font-extrabold text-foreground animate-fadeIn" style={{ animationDelay: '0.5s' }}>
          NEW
        </h1>
        ...
        <div className="mt-8 animate-fadeIn" style={{ animationDelay: '1.5s' }}>
          <Button asChild size="lg" className="bg-primary text-primary-foreground rounded-full px-8 py-6 text-lg font-bold uppercase tracking-wider transition-all duration-300 hover:bg-primary/90 hover:scale-105">
