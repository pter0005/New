    ...
    <section id="method" className="py-20 sm:py-32 bg-background/50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          <Card className="glassmorphism border-2 border-primary/50 transition-all duration-300">
            <CardHeader>
          ...
          <Card className="glassmorphism border border-muted-foreground/30 transition-all duration-300">
            <CardHeader>
        ...
        <p className="mt-12 text-center text-xl font-semibold text-primary/90">
